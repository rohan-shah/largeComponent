...
setClass("sequentialImportanceResult", slots = list(estimate = "mpfrOrNumeric", distinctParticles = "integer", levelProbabilities = "numeric", call = "call", start = "POSIXct", end = "POSIXct", resamplingCounts = "list"))
