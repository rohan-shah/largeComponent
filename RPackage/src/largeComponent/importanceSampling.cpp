...
SEXP importanceSampling(SEXP graph_sexp, SEXP probabilities_sexp, SEXP n_sexp, SEXP seed_sexp, SEXP componentSize_sexp, SEXP importanceProbabilities_sexp, SEXP vertexPositions_sexp)
{
BEGIN_RCPP
